...
function randomNumber( min = 0, max = 1000 /*Number.MAX_SAFE_INTEGER*/ ) {
...
function randomElement( array, min = 0, max = ( array.length - 1 ) ) {
...
function randomKey( obj ) {
    ...
    if (Array.isArray(array)) {
        ...
        return `random key: ${ randomIndex }, its value: ${ obj[ randomIndex ] }`
...
function randomPass( length = 15, strong ) {
...
module.exports.radnomizeArray = radnomizeArray;